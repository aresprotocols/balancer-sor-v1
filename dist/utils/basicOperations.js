...
exports.MathSol = exports.BONE = exports.BZERO = void 0;
exports.BZERO = BigInt(0);
exports.BONE = BigInt(1);
...
class MathSol {
    ...
    static mul(a, b) {
        const c = a * b;
        _require(a == exports.BZERO || c / a == b, 'Errors.MUL_OVERFLOW');
        return c;
    }
    ...
    static divDown(a, b) {
        _require(b != exports.BZERO, 'Errors.ZERO_DIVISION');
        return a / b;
    }
    static divUp(a, b) {
        _require(b != exports.BZERO, 'Errors.ZERO_DIVISION');
        if (a == exports.BZERO) {
            return exports.BZERO;
        } else {
            return exports.BONE + (a - exports.BONE) / b;
        }
    }
    static mulUpFixed(a, b) {
        const product = a * b;
        _require(a == exports.BZERO || product / a == b, 'Errors.MUL_OVERFLOW');
        if (product == exports.BZERO) {
            return exports.BZERO;
        } else {
            ...
            return (product - exports.BONE) / this.ONE + exports.BONE;
        }
    }
    ...
    static divUpFixed(a, b) {
        ...
        if (a == exports.BZERO) {
            ...
            // divUp(x, y) := (x - 1) / y + 1
            // Note that this requires x != 0, which we already tested for.
            return (aInflated - exports.BONE) / b + exports.BONE;
        }
    }
    // Modification: Taken from the fixed point class
    ...
    static complementFixed(x) {
        return x < this.ONE ? this.ONE - x : exports.BZERO;
    }
